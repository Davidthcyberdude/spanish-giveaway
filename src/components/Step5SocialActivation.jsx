...
const Step5SocialActivation = ({ userAnswers, t }) => {
  ...
  const platforms = [
    { id: 'facebook', name: t('facebook'), logo: 'assets/facebook logo.png', color: 'bg-blue-600' },
    { id: 'tiktok', name: t('tiktok'), logo: 'assets/tiktok logo.png', color: 'bg-black' }
  ]
  ...
  const renderLoginForm = () => {
    ...
    if (selectedPlatform === 'tiktok') {
      return (
        ...
        >
          <div className="text-center mb-6">
            <div className="w-16 h-auto flex items-center justify-center mb-2">
              <img 
